...
% TASK 3
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{What is the main idea behind the unsupervised operon prediction method introduced in the class, i.e. why does it “work” without prior knowledge about concrete previously identified operons (sample/training data)?}\\
...
% TASK 4
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{Why are the features for adjacent genes computed separately for closely and distantly related organisms?}\\
